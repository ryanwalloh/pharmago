...
export default function Onboarding2({ onComplete, onNavigateToMain }: Onboarding2Props) {
  ...
  if (showOnboarding3) {
    return <Onboarding3 onComplete={onComplete} onNavigateToMain={onNavigateToMain} />;
  }
      ...
      <View style={styles.content}>
        ...
        <View style={styles.imageContainer}>
          ...
          <View style={styles.textContainer}>
            ...
            We partner only with verified pharmacies to ensure genuine medicines, handled with care.
            </Text>
          </View>
        </View>
      </View>
