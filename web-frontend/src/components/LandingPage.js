  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div
        ...
        style={{ backgroundImage: "url(/images/registerBg2.png)" }}
      >
              ...
              <div className="w-full max-w-md lg:max-w-lg">
                <div className="text-left mb-8">
                  ...
                  <p className="text-xl text-white mb-8 max-w-lg">
                    Join in minutes, add your products, and let us help you
                    serve more people in need of care.
                  </p>
                </div>
              ...
              <div className="pt-6">
                <div className="flow-root bg-[#D5E8D4] rounded-lg px-6 pb-8 h-full flex flex-col">
                  <div className="-mt-6 flex-1 flex flex-col">
                    ...
                    <h3 className="mt-8 text-lg font-medium text-[#2C7A5D] tracking-tight">
                      Expand Your Operations
                    </h3>
                    <p className="mt-5 text-base text-[#4DAF7C] flex-1">
                      Scale your pharmacy business with our comprehensive
                      platform. Reach more customers, and grow your revenue
                      through our integrated solutions.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-6">
                <div className="flow-root bg-[#D5E8D4] rounded-lg px-6 pb-8 h-full flex flex-col">
                  <div className="-mt-6 flex-1 flex flex-col">
                    ...
                    <p className="mt-5 text-base text-[#4DAF7C] flex-1">
                      Handle prescriptions, manage customer orders, and
              ...
              <div className="pt-6">
                <div className="flow-root bg-[#D5E8D4] rounded-lg px-6 pb-8 h-full flex flex-col">
                  <div className="-mt-6 flex-1 flex flex-col">
                    ...
                    <p className="mt-5 text-base text-[#4DAF7C] flex-1">
                      Coordinate deliveries, track packages, and ensure timely
                      medication delivery to your customers.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-6">
                <div className="flow-root bg-[#D5E8D4] rounded-lg px-6 pb-8 h-full flex flex-col">
                  <div className="-mt-6 flex-1 flex flex-col">
                    ...
                    <p className="mt-5 text-base text-[#4DAF7C] flex-1">
                      Build lasting relationships with your customers through
                      personalized care and efficient service.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-6">
                <div className="flow-root bg-[#D5E8D4] rounded-lg px-6 pb-8 h-full flex flex-col">
                  <div className="-mt-6 flex-1 flex flex-col">
                      ...
                      <span className="inline-flex items-center justify-center p-3 bg-[#6BBF9A] rounded-md shadow-lg">
                        ...
                        >
                          <path
                            ...
                            strokeLinejoin="round"
                            strokeWidth={2}
                            d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"
                          />
                        </svg>
                      </span>
                    </div>
                    ...
                    <p className="mt-5 text-base text-[#4DAF7C] flex-1">
                      Get insights into your business performance with
              ...
              <div className="pt-6">
                <div className="flow-root bg-[#D5E8D4] rounded-lg px-6 pb-8 h-full flex flex-col">
                  <div className="-mt-6 flex-1 flex flex-col">
                    ...
                    <p className="mt-5 text-base text-[#4DAF7C] flex-1">
                      HIPAA compliant with enterprise-grade security to protect
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          ...
          <div className="mt-8 flex lg:mt-0 lg:flex-shrink-0">
            <div className="inline-flex rounded-md shadow">
              <a
                href="#signup"
                className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-green-600 bg-white hover:bg-gray-50 transition-colors"
              >
                Get started
              </a>
            </div>
            <div className="ml-3 inline-flex rounded-md shadow">
              <a
                href="#contact"
                className="inline-flex items-center justify-center px-5 py-3 border border-white text-base font-medium rounded-md text-white bg-green hover:bg--400 transition-colors"
              >
                Learn more
              </a>
            </div>
