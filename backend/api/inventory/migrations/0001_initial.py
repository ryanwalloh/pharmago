    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pharmacy', models.ForeignKey(help_text='Pharmacy that owns this inventory item', on_delete=django.db.models.deletion.CASCADE, related_name='inventory_items', to='users.pharmacy')),
            ],
            options={
