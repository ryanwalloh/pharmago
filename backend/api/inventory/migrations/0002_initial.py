...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='pharmacy',
            field=models.ForeignKey(help_text='Pharmacy that owns this inventory item', on_delete=django.db.models.deletion.CASCADE, related_name='inventory_items', to='pharmacies.pharmacy'),
        ),
        migrations.AddIndex(
