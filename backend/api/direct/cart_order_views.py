...
def create_cart_order(request):
    ...
    try:
        ...
        with transaction.atomic():
            ...
            # Step 2: Calculate service fee (waived for seniors)
            ...
            # Step 3: Calculate senior discount (20% off subtotal if requested)
            discount_amount = Decimal('0.00')
            senior_discount_status = 'not_requested'
            
            if senior_discount_requested and senior_id_image_url:
                discount_amount = subtotal * Decimal('0.20')  # 20% discount
                senior_discount_status = 'pending'  # Pending pharmacy approval
            ...
            # Step 7: Build response with pharmacy info for tracking
            ...
            return JsonResponse({
                ...
                'order': {
                    ...
                    'estimated_delivery': None,  # Set by pharmacy
                    'notes': order.notes
                }
            }, status=201)
